...
public class CardShop : Shop
{
    ...
    public void Purchase(float axisValue)
    {
        ...
        CardGood SelectedGood = Stock[selection];
    ...
    {
        Stock = new CardGood[(int)Random.Range(minStockCount, maxStockCount)];
        stockPurchased = new bool[Stock.Length];
